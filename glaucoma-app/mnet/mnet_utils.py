...
def pro_process(temp_img, input_size):
    img = Image.fromarray(np.uint8(temp_img*255))    
...
if __name__ == '__main__':
    im1 = np.asarray(Image.open('11.jpg')).astype('uint8')
    im2 = pro_process(im1, 400)
    Image.fromarray(np.uint8(im2*255)).save('12.jpg')
